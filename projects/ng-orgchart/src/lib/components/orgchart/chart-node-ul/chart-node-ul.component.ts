...
@Component({
  selector: 'lib-chart-node-ul',
  templateUrl: './chart-node-ul.component.html',
  styleUrls: ['./chart-node-ul.component.css'],
  animations: [
...
export class ChartNodeUlComponent implements OnInit {

  @Input() datasource: Node;
  @Input() arrDataSource:Node[];
  @Input() nodeHeading;
  @Input() nodeContent;
  @Input() nodeColor;
